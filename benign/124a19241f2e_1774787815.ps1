...
.EXAMPLE
   .\Remove-SiteCollectionAdminFromODFB.ps1 -TenantName <Name_of_the_O365_Tenant> -AdminAcct <O365_AdminAccount> -SecondAdmin <2nd_SCA_acct> -ODFBCsvFile <File_containing_the_ODFB_Urls.csv>
.EXAMPLE
   .\Remove-SiteCollectionAdminFromODFB.ps1 (if no parameters are entered, you will be prompted for them)
