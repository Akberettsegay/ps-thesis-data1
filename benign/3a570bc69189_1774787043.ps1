...
<#
        .SYNOPSIS
		Azure Collector to get Security Contacts
	...
	begin {
		...
		$monkey_metadata = @{
			...
			ResourceType = $null;
			resourceName = $null;
			collectorName = "Get-MonkeyAzSecurityContact";
			ApiType = "resourceManagement";
			description = "Collector to get Security Contacts fron Azure";
			Group = @(
				"Subscription"
			);
			Tags = @(
