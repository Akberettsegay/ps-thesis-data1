    ...
    process {
        if ($GroupSearcher) {
            if ($Recurse -and $UseMatchingRule) {
                ...
                if ($GroupName) {
                    $Group = Get-NetGroup -GroupName $GroupName -Domain $TargetDomain -DomainController $TargetDomainController -FullData -PageSize $PageSize
                }
                elseif ($SID) {
                    $Group = Get-NetGroup -SID $SID -Domain $TargetDomain -DomainController $TargetDomainController -FullData -PageSize $PageSize
                }
                else {
