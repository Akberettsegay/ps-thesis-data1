function Disable-ASLR {
    Get-Item -Path "C:\Program Files\Git\bin\*.exe" | ForEach-Object { 
        Set-ProcessMitigation -Name $_.Name -Disable ForceRelocateImages
        Write-Output "Disabled ASLR for $_"
    }
    
    Get-Item -Path "C:\Program Files\Git\usr\bin\*exe" | ForEach-Object { 
        Set-ProcessMitigation -Name $_.Name -Disable ForceRelocateImages
        Write-Output "Disabled ASLR for $_"
    }
    
    Get-Item -Path "C:\Program Files\Git\mingw64\bin\*.exe" | ForEach-Object { 
        Set-ProcessMitigation -Name $_.Name -Disable ForceRelocateImages
        Write-Output "Disabled ASLR for $_"
    }
    
    Get-Item -Path "C:\Program Files\Git\mingw64\libexec\git-core\*.exe" | ForEach-Object {
        Set-ProcessMitigation -Name $_.Name -Disable ForceRelocateImages
        Write-Output "Disabled ASLR for $_"
    }
}
