...
Function Install-LAPS {
    ...
    if ($null -eq $LAPSComputer) {
        Write-Log -Message "No computer found to install LAPS on" -Level "Warning"
        return
    }
    ...
    Write-Log -Message "$VulnUser can read $LAPSComputer LAPS password" -Level "Informational"
