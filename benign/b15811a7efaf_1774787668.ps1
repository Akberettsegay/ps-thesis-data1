...
[CmdletBinding()]
    Param (
        ...
        [Parameter(Mandatory=$False)][switch]$IncludePerGB = $true                                      ## Set to $false to exclude Per GB products from reports
    )
...
Function Open-FileName {
    ...
    $OpenFileDialog.Filter = "N-able Billing efile(*.csv;*.xlsx)|*.csv;*.xlsx"
