...
Get-VM -Name VCSA,Debian7-VM | Set-VM -NumCpu 2
...
Get-Help Remove-Datastore -full | more

# Help topics on specific concepts :
Get-Help about_*

# Search through all the helpfiles for a keyword
Get-Help conditional
