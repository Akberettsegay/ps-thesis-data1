...
if ($env:SQL_SERVER_EDITION -eq 'EXPRESS') {
    ...
    $archiveUrl = if ($env:SQL_SERVER_EDITION -eq 'STANDARD-DEVELOPER') {
        'https://download.microsoft.com/download/77dc60d3-0139-4dad-83c8-bb52ab22db01/SQL2025-SSEI-StdDev.exe'
    } else {
