...
https://github.com/O365scripts/O365scripts/blob/master/Connection/O365ConnectExchangeOnlinBasicDeprecated.ps1
...
.LINK
Reference:
https://learn.microsoft.com/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/connect-to-exchange-online-powershell
https://learn.microsoft.com/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/mfa-connect-to-exchange-online-powershell
https://cmdletpswmodule.blob.core.windows.net/exopsmodule/Microsoft.Online.CSE.PSModule.Client.application
#>
