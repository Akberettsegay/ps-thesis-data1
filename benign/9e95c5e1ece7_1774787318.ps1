...
function New-Manifest {
    ...
    if ($AdminToolbox) {
        ...
        $Params = @{
            ...
            FunctionsToExport    = 'Get-All', 'Get-Info', 'Get-Full', 'Start-Application', 'Get-ModuleAliases', 'Invoke-Show', 'Get-FormattedDate'
    ...
    if ($EndpointManagement) {
        ...
        $Params = @{
            CompatiblePSEditions = "Desktop", "Core"
            FunctionsToExport    = 'Add-LocalAdmin', 'Disable-Firewall', 'Disable-PasswordPeek', 'Disable-ShakeToMinimize', 'Enable-Firewall', 'Enable-RSATFeatures', 'Get-Applications', 'Get-ChocoOutdated', 'Get-IntroPCS', 'Get-Management', 'Get-PCInfo', 'Get-PrintBackup', 'Get-Printers', 'Get-PrintManagement', 'Get-EndpointManagement', 'Install-Chocolatey', 'Install-ChocoPackages', 'Invoke-ChocoUpgrade', 'Invoke-PrinterServerRenew', 'Join-Domain', 'Remove-PrintQueue', 'Remove-Shortcuts', 'Remove-Tiles', 'Get-ChocoInstalls', 'Uninstall-Application', 'Reset-EndpointPassword', 'Repair-DomainJoin', 'Disable-Cortana', 'Get-MonitorSizes', 'Get-RebootEvents', 'Get-RemoteDesktopLogins', 'Get-LocalLogonHistory', 'Get-WindowsProfiles'
    ...
    if ($FileManagement) {
        ...
        $Params = @{
            CompatiblePSEditions = "Desktop", "Core"
            FunctionsToExport    = 'Get-FileManagement', 'Find-ComputersFiles', 'Get-FileOwner', 'Get-FolderSize', 'Invoke-Robocopy', 'Remove-All', 'Remove-DisabledADProfiles', 'Remove-OlderThan', 'Get-ShareReport', 'Get-FolderName', 'Get-FileName', 'Use-WSLnano', 'Get-EmptyDirectory', 'Get-LastUsedDirectory', 'Find-MovedFolder', 'Set-BackupPrivilege', "Get-LastUsedItem"
    ...
    if ($Networking) {
        ...
        $Params = @{
            CompatiblePSEditions = "Desktop", "Core"
            FunctionsToExport    = 'Get-Networking', 'Clear-Arp', 'Get-NetworkStatistics', 'Get-PublicIP', 'Get-MacVendor', 'Invoke-NetworkScan', 'Reset-NetworkAdapter', 'Reset-NetworkStack', 'Invoke-Iperf', 'Start-SpeedTest', 'Get-Whois', 'Invoke-Monitor', 'Show-IPInfo', 'Invoke-Ethr', 'Invoke-PSIPcalc', 'Get-NICConfig', "Get-SpeedTestCLI", "Open-HostsFile"
    ...
    if ($SecOps) {
        ...
        $Params = @{
            CompatiblePSEditions = "Desktop", "Core"
            FunctionsToExport    = 'Get-SecOps', 'Convert-Base64', 'Get-BitlockerRecovery', 'Get-HiddenServices', 'Invoke-BitlockerSetup', 'Set-UAC', 'Set-ScreenTimeout', 'Set-DNSBroadcasting', 'Disable-WindowsTelemetry', 'Dismount-ProfileRegistry', 'Mount-ProfileRegistry'
