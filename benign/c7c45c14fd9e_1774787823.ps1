Function Add-LineForward {
	...
	.EXAMPLE
		Add-LineForward -Pattern 1234 -RoutePartition 0_Internal_pt -Voicemail

		# Forwards all calls to voicemail for x1234 in partition 0_Internal_pt

	.EXAMPLE
		Add-LineForward -Pattern 4567 -RoutePartition Executive_pt -Destination 815085551234 -DestinationCSS National_css
