...
add-type -AssemblyName "Microsoft.SqlServer.ConnectionInfo, version=13.0.0.0, Culture=Neutral, PublicKeyToken=89845dcd8080cc91";
...
{
    write-output "I found NO replicated databases on Server $server"
    exit
}
else
{
