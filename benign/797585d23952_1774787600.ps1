...
New-WmiEventConsumer -Name ProcessStarted -ConsumerType EventLog -EventType Information -EventId 9898 `
	-InsertionStringTemplates "Process has started: %TargetInstance.ProcessName%"