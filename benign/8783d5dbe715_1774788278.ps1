Function New-Pre2KComputerAccount {
    ...
    Write-Log -Message "Creating a Pre 2k Computer Account"
    ...
    Write-Log -Message "$Pre2KComputer computer created with the password '$($Name.ToLower())'" -Level "Informational"
}