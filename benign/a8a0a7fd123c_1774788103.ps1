...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module pwshCloudCommands.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain pwshCloudCommands.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "pwshCloudCommands.psm1"
        } #validPSM1
