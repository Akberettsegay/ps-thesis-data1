...
$logAction = New-FsrmAction Event -EventType Information `
  -Body "An user attempted to create a forbidden file in the shared folder." `
  -RunLimitInterval 60
...
$fsTemplate = New-FsrmFileScreenTemplate -Name "Deny All Type of Files" `
  -IncludeGroup "All files" -Notification $logAction -Active
...
New-FsrmFileScreenException -Path "C:\Shared\" `
  -IncludeGroup "Image Files", "Office Files"